...
export default function CoursePage() {
  ...
  const syllabus = [
    ...
    { title: "Month 2: Advanced Admin & Automation Tools (Flow, PB)" },
    { title: "Month 3: Apex Programming Fundamentals" },
    { title: "Month 4: Advanced Apex, Triggers & Integrations" },
    { title: "Month 5: Lightning Web Components (LWC)" },
    { title: "Month 6: DevOps, Deployment & Interview Preparation" },
  ];
  ...
  const faqs = [
    {
      ...
      a: "Yes, no prior Salesforce experience is required.",
    },
    {
    ...
    {
      q: "Will this help me get Salesforce jobs?",
      a: "Yes, this course prepares you for Salesforce Admin & Developer roles.",
    },
    {
    ...
    {
      q: "Is this aligned with Salesforce certifications?",
      a: "Yes, it aligns with Salesforce Admin & PD1 certification paths.",
    },
  ];

  const instructor = {
    name: "Rohit Verma",
    title: "Salesforce Developer & CRM Consultant",
    bio: "6+ years in Salesforce Administration, Apex Development, LWC, Integrations & Enterprise Deployments.",
    ...
    >
      ...
      />
              ...
              <p className="mt-3 text-lg text-slate-200 max-w-3xl">
                Become a job-ready Salesforce Administrator & Developer with hands-on CRM, Apex, LWC, Integrations & Automation.
              </p>

              <div className="mt-5 text-sm text-slate-100 max-w-3xl">
                <p className="mb-3">
                  A comprehensive, industry-aligned Salesforce program designed to take you from beginner to job-ready professional in 6 months.
                </p>

                <div className="flex flex-wrap gap-3">
                  <Chip>Beginner to Advanced</Chip>
                  <Chip>6 Months</Chip>
                  <Chip>Live Classes</Chip>
                </div>
              </div>
              ...
              <div className="mt-6">
                <button
                  ...
                  className="bg-[#009990] hover:bg-[#007f6f] text-white px-5 py-3 rounded-md mr-4"
                >
                  Explore Course
                </button>
                ...
                <button
                  ...
                  className="bg-white/20 hover:bg-white/30 text-white px-5 py-3 rounded-md"
                >
                  Watch Intro Video
                </button>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-md shadow p-6 mb-10">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            A comprehensive, industry-aligned Salesforce Development & Administration program designed to take you from beginner to job-ready professional in 6 months. This course covers CRM fundamentals, Salesforce administration, automation tools (Flow, Process Builder), Apex programming, Lightning Web Components (LWC), REST API integrations, and enterprise deployment practices.
            <br /><br />
            You will gain hands-on experience building real-world CRM applications, automation workflows, custom objects, Apex triggers, and LWC-based user interfaces. The curriculum emphasizes live projects, case studies, and practical assignments aligned with Salesforce Admin and Platform Developer 1 (PD1) certification paths.
            <br /><br />
            By the end of the program, you will have built production-ready Salesforce applications, developed strong CRM implementation skills, and gained the confidence to apply for Salesforce Administrator, Salesforce Developer, CRM Consultant, or Business Analyst roles. This course is ideal for students, freshers, and professionals who want to build a future-proof career in the Salesforce ecosystem.
          </p>
        </div>
        ...
        <section ref={videosRef} id="videos" className="py-16 px-6 bg-white mb-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { title: "Program Overview", link: "https://www.youtube.com/embed/dummy_link_1" },
                { title: "What You Will Learn", link: "https://www.youtube.com/embed/dummy_link_2" },
                { title: "Career Opportunities", link: "https://www.youtube.com/embed/dummy_link_3" },
              ].map((vid, i) => (
                <div key={i} className="rounded-xl shadow-lg overflow-hidden bg-gray-100">
                  <iframe
