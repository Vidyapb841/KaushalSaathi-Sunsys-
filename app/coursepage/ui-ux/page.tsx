...
<p className="text-sm text-gray-700 leading-relaxed">
  A comprehensive, industry-aligned UI/UX Design program designed to take you from beginner to job-ready professional. This course covers the complete design process—from user research and design thinking to wireframing, prototyping, and high-fidelity UI design using modern design tools.
  <br /><br />
  You will learn how to create intuitive, user-centered digital experiences by understanding user behavior, information architecture, interaction design, and usability principles. The curriculum emphasizes hands-on learning through real-world projects, case studies, and portfolio development to help you apply design concepts in practical scenarios.
  <br /><br />
  By the end of the course, you will have built a professional UI/UX portfolio, gained a strong understanding of user experience strategy and interface design best practices, and developed the confidence to apply for UI/UX designer roles, product designer roles, or design internships. This course is ideal for students, freshers, and professionals who want to build a future-proof career in UI/UX design.
</p>
 ...
 {/* ⭐⭐ VIDEO SECTION WITH REF ⭐⭐ */}
  ...
  { q: "Do I need any design or coding background?", a: "No, this course starts from the basics and is designed for complete beginners." },
  { q: "Will I build real-world projects?", a: "Yes, you will work on multiple real-world UI/UX projects and case studies for your portfolio." },
  { q: "Will I get a certificate after completion?", a: "Yes, you will receive an industry-recognized completion certificate after finishing the course." },
  { q: "Is this course suitable for working professionals?", a: "Yes, the course offers flexible learning options suitable for students and working professionals." },
  { q: "Will this help me get a UI/UX design job or internship?", a: "Yes, the course includes portfolio building, interview preparation, and career guidance to help you get hired." },
]}
