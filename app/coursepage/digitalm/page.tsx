...
<p className="text-sm text-gray-700 leading-relaxed">
  A comprehensive, industry-aligned Digital Marketing program designed to take you from beginner to job-ready professional. This course covers the complete modern marketing stack—including SEO, PPC advertising, content marketing, social media marketing, branding, and conversion rate optimization (CRO)—along with full-funnel marketing frameworks used by top companies.
  <br /><br />
  You will learn how to plan, execute, and optimize data-driven marketing campaigns across multiple digital channels. The curriculum emphasizes hands-on learning through real-world projects, case studies, and practical assignments covering AI marketing tools, analytics, customer acquisition funnels, D2C strategies, and performance marketing.
  <br /><br />
  By the end of the course, you will have built a strong digital marketing portfolio, gained practical experience with industry-standard tools like Google Analytics, Google Ads, Meta Ads, SEO platforms, and AI automation tools, and developed the confidence to apply for digital marketing roles, performance marketing roles, growth marketing roles, or freelance opportunities. This course is ideal for students, freshers, entrepreneurs, and professionals who want to build a future-proof career in digital marketing.
</p>
